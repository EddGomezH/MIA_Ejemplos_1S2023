...
int main()
{
    ...
    while (eleccion != 7)
    {
        ...
        cout << "      5. Editar Registro X                " << endl;
        cout << "      6. Eliminar Registro X              " << endl;
        cout << "      7. Salir                            " << endl;
        cout << "------------------------------------------" << endl;
        getline(cin, opcion);
        ...
        case 5:
            cout << "-----------------------------------------" << endl;
            cout << "      Editar X registro en el archivo       " << endl;
            cout << "-----------------------------------------" << endl;
            cout << "   Ingrese el indice del registro a editar (>0)   " << endl;
            getline(cin, opcionsub);
            xreg = atoi(opcionsub.c_str()) - 1;
            cout << "-----------------------------------------" << endl;
            archivo_binario = fopen("Ejemplo2.dsk", "rb+");
            ...
            cout << "Tamano Struct: ";
            cout << sizeof(ejm) << endl;
            strcpy(ejm.nombre, "ejemplo3 edit");
            strcpy(ejm.direccion, "dir edit");
            mostrar_struct(ejm);
            cout << "Tamano Struct: ";
            cout << sizeof(ejm) << endl;
            fseek(archivo_binario, xreg * sizeof(Ejemplo), SEEK_SET);
        ...
        case 6:
            cout << "-----------------------------------------" << endl;
            cout << "      Eliminar X registro en el archivo       " << endl;
            cout << "-----------------------------------------" << endl;
            cout << "   Ingrese el indice del registro a eliminar (>0)   " << endl;
            getline(cin, opcionsub);
            xreg = atoi(opcionsub.c_str()) - 1;
            cout << "-----------------------------------------" << endl;
            archivo_binario = fopen("Ejemplo2.dsk", "rb+");
