...
void Analizador::LeerEntrada(string txt){
    ofstream file;
        ...
        if(raiz->Nombre == "INICIO"){
           ...
           Recorrer(raiz->Hojas[0]);
            ...
            if(raiz->Hojas[0]->Nombre == "Crear"){
                ...
                ComandoC = "Verx";
            }else if(raiz->Hojas[0]->Nombre == "Editarx"){
                cout << "*----------------------------------------------------------*" << endl;
                cout << "Ejecucion de Verx..." << endl;
                ComandoC = "EditarX";
            }
...
void Analizador::EjecutarComando(Resultado r){
    if(r.Comando == "Crear"){
        ...
        EjecutarVerx(r);
    }else if (r.Comando == "Editarx") {
        cout << "Editar X. OK" << endl;
        cout << "X:";
        cout << "=";
        cout << r.X << endl;
    }
...
void Analizador::EjecutarCrear(Resultado r){
    if(r.Tamano != " " && r.Dimensional != " "){
       cout << "Crear: OK" << endl;
       com.crearArchivo(r.Tamano,r.Dimensional.c_str());
   }else{
